...
```bash
git remote add encore encore://studyflow-platform-t8ii
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/studyflow-platform-t8ii/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/studyflow-platform-t8ii/settings/integrations/github)
