 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { collaboration as api_groups_collaboration_collaboration } from "~backend/groups/collaboration";
...
export namespace groups {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.collaboration = this.collaboration.bind(this)
            this.create = this.create.bind(this)
         ...
         */
        public async collaboration(): Promise<StreamInOut<StreamRequest<typeof api_groups_collaboration_collaboration>, StreamResponse<typeof api_groups_collaboration_collaboration>>> {
            return await this.baseClient.createStreamInOut(`/groups/${encodeURIComponent(params.groupId)}/live`)
        }
